  ...
  <div class="transport-detail">
    ...
    <template v-else>
      ...
      <div v-if="heroUrl" class="hero">
        <img :src="heroUrl" :alt="item.name" class="hero-img" />
      </div>
      ...
      <section v-if="item.events?.length" class="section">
        <div class="section-header-row">
          <h3 class="section-heading">Hendelser ({{ item.events.length }})</h3>
      ...
      <section v-if="item.gallery?.length" class="section">
        ...
        <div class="carousel">
          ...
          <img
            :src="currentImageUrl"
            :alt="`${item.name} bilde ${currentImageIndex + 1}`"
            class="carousel-img"
          />
...
const meta = computed(() => {
  ...
  return [item.value.type, item.value.unit, item.value.regser, item.value.reserve]
